...
In the following section, we simulate EMG signals on the upper arm.
...
We compute scenarios with between \num{1369} and \num{76729} fibers (TODO check numbers). The specified number of 100 MUs have to be assigned to these numbers of fibers for each scenario.
...
\begin{figure}
  ...
  \begin{subfigure}[t]{0.19\textwidth}%
    \centering%
    \includegraphics[height=12cm]{images/results/application/emg277.png}%
    \caption{\num{76729} fibers}%
    \label{fig:emg277}%
  \end{subfigure}
