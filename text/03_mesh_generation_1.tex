...
\end{align*}
As a result, we can generate a 3D mesh where the number of points in $x$ and $y$ direction can be adjusted by the parameter $m$.
...
\begin{figure}
  ...
  \begin{subfigure}[t]{0.78\textwidth}%
    \centering%
    \includegraphics[width=\textwidth]{images/parallel_fiber_estimation/structured_grid_n_nodes.pdf}%
    \caption{Fibers}%
