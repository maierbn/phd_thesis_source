...
{%
  ...
  \begin{center}
    \includegraphics[height=15mm]{images/logos/logoUniversityEnglishGray}%
  ...
  \begin{tabular}{ll}
    ...
    \raisebox{-0.4\height}{%
      \includegraphics[height=15mm]{images/logos/logoSimTechGray}%
    }%
    \hspace{5mm}%
    \raisebox{-0.5\height}{%
      \includegraphics[height=17mm]{images/logos/logoIPVSGray}%
    }%
    \hspace{6mm}%
    \raisebox{-0.5\height}{%
      \includegraphics[height=19mm]{images/logos/logoSGSGray}%
    }
  \end{tabular}
  ...
  \smash{%
    \rlap{%
      \hspace*{-29mm}\includegraphics[width=25mm]{images/logos/licenseBadge.png}%
    }%
  }%
