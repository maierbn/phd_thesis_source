...
%\input{03_mesh_generation_0}
%\input{03_mesh_generation_1}
%\input{04_motor_units}
%\input{05_theory_0}
%\input{05_theory_1}
%\input{05_theory_2}
%\input{05_theory_3}
...
%\input{07_implementation_0}
%\input{07_implementation_1}
%\input{07_implementation_2}
...
% consistency checks: C++ (groß), finite element method, finite elements (klein)
% fiber based electrophysiology, (dashes), multi-scale,  cross section, timestep
% diffusion -> electric conduction,  circa -> approximately, geomerty, Mu, artifical
% typos: communciation
